...
/***/ function(module, exports, __webpack_require__) {
	...
	var _FilterableProductTable = __webpack_require__(159);

	var _FilterableProductTable2 = _interopRequireDefault(_FilterableProductTable);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var db = [{ category: "Sporting Goods", price: "$49.99", stocked: true, name: "Football" }, { category: "Sporting Goods", price: "$9.99", stocked: true, name: "Baseball" }, { category: "Sporting Goods", price: "$29.99", stocked: false, name: "Basketball" }, { category: "Electonics", price: "$99.99", stocked: true, name: "iPod Touch" }, { category: "Electonics", price: "$399.99", stocked: false, name: "iPhone 5" }, { category: "Electonics", price: "$1999.99", stocked: true, name: "Nexus 7" }];

	var app = document.getElementById('app');
	_reactDom2.default.render(_react2.default.createElement(_FilterableProductTable2.default, { store: db }), app);
	    ...
	    _createClass(FilterableProductTable, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                'div',
	                null,
	                _react2.default.createElement(_SearchBar2.default, { onChange: this.filterList.bind(this) }),
	                _react2.default.createElement(_ProductTable2.default, { products: this.props.store, filter: this.state.filter })
	            );
	        }
	    }]);
	    ...
	    _createClass(SearchBar, [{
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                "div",
	                null,
	                _react2.default.createElement("input", { onChange: this.props.onChange, type: "text" }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProductTable = function (_React$Component) {
	    ...
	    function ProductTable() {
	        ...
	        return _possibleConstructorReturn(this, (ProductTable.__proto__ || Object.getPrototypeOf(ProductTable)).call(this));
	    }
	            ...
	            if (this.props.filter != null && this.props.products != null) {
	                this.props.products.forEach(function (product) {
	                    ...
	                    if (product.name.indexOf(filter) > -1) {
	                        if (product.category != last_category) rows.push(_react2.default.createElement(_ProductCategoryRow2.default, { category: product.category, key: product.category }));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProductCategoryRow = function (_React$Component) {
	    ...
	    function ProductCategoryRow() {
	        ...
	        return _possibleConstructorReturn(this, (ProductCategoryRow.__proto__ || Object.getPrototypeOf(ProductCategoryRow)).call(this));
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ProductRow = function (_React$Component) {
	    ...
	    function ProductRow() {
	        ...
	        return _possibleConstructorReturn(this, (ProductRow.__proto__ || Object.getPrototypeOf(ProductRow)).call(this));
	    }
